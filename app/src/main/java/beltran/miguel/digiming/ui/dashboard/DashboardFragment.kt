package beltran.miguel.digiming.ui.dashboard
...
import beltran.miguel.digiming.ui.home.HomeFragment
...
class DashboardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        root.btn_save.setOnClickListener {
            ...
            var actividad=Actividad(title,days,time)
            HomeFragment.actividades.add(actividad)
